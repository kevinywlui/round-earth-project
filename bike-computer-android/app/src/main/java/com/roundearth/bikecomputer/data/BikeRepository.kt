...
class BikeRepository(
    ...
    suspend fun exportCsv(): String = buildString {
        append("session_id,timestamp_ms,cumulative_revolutions,sensor_event_time_1024,wheel_circumference_m,heading_degrees,true_heading_degrees\n")
        for (e in dao.getAll()) {
            ...
            append(e.trueHeadingDegrees).append('\n')
        }
    }
